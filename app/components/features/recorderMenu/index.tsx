...
} from "@/features/recorderMenu/buttonItems"
...
export default function RecorderMenu() {
  ...
  const [selectedRecordingOption, setSelectedRecordingOption] =
    useState<RecordingType | null>(() => recordingData?.type ?? null)
    ...
    <>
      <div className={"recorder_menu"} id="recorder-main">
        {!selectedRecordingOption ? (
          <>
            <div className="recorder_menu__toolbar mx-auto max-w-[780px]">
            ...
            <div className={"recorder_menu__container"}>
              ...
              <p className={"recorder_menu__container__subtitle"}>
                {tMenu("subtitle")}
              </p>
            ...
            <div
              className={`recorder_menu__enumerating ${isRequestingPermissions ? "show" : "hide"}`}
            >
              <div className={"recorder_menu__enumerating__container"}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={"/images/svg/perms_allow.svg"}
                  alt={tPermissions("requestingAlt")}
                />
